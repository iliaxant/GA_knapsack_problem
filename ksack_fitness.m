...
% (BEST SO FAR) Overweight penalty (value and weight)
...
scores = ~is_overweight + overweight .* is_overweight * over_penalty;
scores = scores ./ total_values;




% % 1st method of overweight & underweight penalty (value and weight)
% 
% over_penalty = 100;
% under_penalty = 10;
% 
